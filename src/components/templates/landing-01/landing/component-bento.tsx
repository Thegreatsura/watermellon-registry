...
import Switch3 from "@/components/base-variants/switch/switch-3";
import Button4 from "@/components/base-variants/button/button-4";
import Breadcrumb7 from "@/components/base-variants/breadcrumb/breadcrumb-7";
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <Heading
              as="h2"
              variant="big"
              className="text-balance text-foreground font-sans text-left md:text-right"
            >
          ...
          <motion.p
            variants={itemVariants}
            className="mt-6 text-sm text-white/50 text-pretty max-w-lg font-mono uppercase tracking-widest leading-relaxed text-left md:text-right"
          >
            The fundamental architecture of your next great application. Robust,
            accessible, and highly customizable structure.
          </motion.p>
        </motion.div>
